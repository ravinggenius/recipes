...
var MemoryJournal, Serializer, Stm, copy, transaction;
...
module.exports = function(_arg) {
  var journal, klass, opts, store;
  store = _arg.store, journal = _arg.journal;
  if (!journal) {
    journal = new MemoryJournal;
  } else if (journal.constructor === Object) {
    klass = journal.klass, opts = journal.opts;
    klass || (klass = MemoryJournal);
...
Stm.prototype.commit = function(txn, cb) {
  var eachCb, journal, store, txnApplier, ver;
