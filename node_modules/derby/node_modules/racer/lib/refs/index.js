...
var Ref, RefList, derefPath, diffArrays, equal, exports, isPrivate, isServer, mixin, racer, regExpPathOrParent, regExpPathsOrChildren, _ref, _ref1,
  __slice = [].slice;
...
mixin = {
  ...
  proto: {
    ...
    fn: function() {
      var fn, i, input, inputs, model, path, _i, _j, _len;
